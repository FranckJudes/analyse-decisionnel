...
export function ProcessMonitorPage() {
  ...
  // Si des logs partagés arrivent depuis Simulation/ETL → passer en mode import
  useEffect(() => {
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
          ...
          <div className="relative" style={{ height: 480 }}>
            {loading ? (
              ...
              <BpmnKpiViewer xml={bpmnXml} kpiData={kpiData} onNodeClick={(id, kpi) => { setSelectedNode(id); setSelectedNodeKpi(kpi); }} />
            ) : (
              <div className="flex flex-col items-center justify-center h-full text-slate-400 gap-3">
